...
int main(int argc, char* argv[]) {
	...
	oVideoWriter.open("result.avi", CV_FOURCC('P','I','M','1'), 20, frameSize, true); //initialize the VideoWriter object 
	...
	cout << "Time(seconds): " << TT << " Troughput: "<< TR << endl;
